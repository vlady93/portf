    ...
    return (
        <section className="container mx-auto px-2 lg:px-22 xl:px-28 2xl:max-w-[1200px] mt-10">
            <header className="mt-24 lg:mt-28 mb-8 lg:mb-12 max-w-[800px] mx-auto lg:flex lg:items-center lg:gap-6">
                ...
                />
                <div>
                    <h1 className="text-4xl font-bold text-primary-600 dark:text-yellow-500 my-4 lg:my-0 lg:mb-4">
                        {data.title}
                    </h1>
                    <ul className="list-none md:flex md:gap-8 mb-4">
                        <li className="flex gap-1 items-center text-dark-700 dark:text-yellow-500 text-sm">
                            <svg
                        ...
                        <li className="flex gap-1  text-dark-700 dark:text-yellow-500 text-sm">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                fill="none"
                                viewBox="0 0 24 24"
                    ...
                    <div className="flex gap-2">
                        {data?.link && (
                            <a
                                href={data?.link}
                                target="_blank"
                                className="flex items-center gap-1 text-primary-600 dark:text-yellow-500 font-bold hover:underline transition-all duration-200"
                            >
                                Ir al sitio{' '}
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
            ...
            <main id="article-body" className="max-w-[800px] mx-auto ">
                <article >
                    <h2 className="dark:text-yellow-500">Resumen</h2>
                ...
                <figure className="table">
                    ...
                    <table>
                        <tbody>
                            <tr>
                                <td className='dark:text-yellow-500'>Tecnología</td>
                                <td className='dark:text-yellow-500'>Uso</td>
                            </tr>
