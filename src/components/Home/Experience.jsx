                ...
                <ul className="relative border-l border-dark-400 dark:border-dark-700">
                    {experienceInfo.map((experience) => (
                        <li key={experience.date} className="mb-8 md:mb-6 ml-6 ">
                            ...
                            <h3 className="flex items-center gap-2 mb-1 text-lg font-semibold text-primary-700 dark:text-yellow-500">
                                {experience.role} <span class="dark:text-white text-dark-700 font-normal">-</span>
                                <span className="text-sm text-crusta-800 dark:text-crusta-500">
                                    {experience.company}
                                </span>
                            </h3>
