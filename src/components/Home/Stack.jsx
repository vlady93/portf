    ...
    return (
        <Container>
            ...
            <p class="my-8 text-pretty md:text-lg max-w-[740px] text-dark-700 dark:text-dark-200">
                En mi viaje por el{' '}
                <span class=" text-daintree-700 dark:text-yellow-500">mundo del desarrollo web</span>, he cultivado{' '}
                <span class="text-crusta-700 dark:text-yellow-500">experiencia y habilidades</span> en una variedad de
                tecnologías.{' '}
                <span class="text-daintree-700 dark:text-crusta-500 font-semibold">Mi stack tecnológico incluye</span>
                :
            </p>
